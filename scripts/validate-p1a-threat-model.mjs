...
export function validateOrdinaryCiActionPins(source) {
  ...
  assert.equal(uses.length, 9, "ordinary CI action inventory changed");
...
const TRUSTED_CURRENT_CONTRACT_ADDITION = [
  ...
  "        if: always()",
  "        run: |",
  "          rm -rf .p1a-original-candidate .p1a-trusted-baseline .p1a-dual-base-authority .p1a-evidence-base-authority .p1a-ancestry-authority",
