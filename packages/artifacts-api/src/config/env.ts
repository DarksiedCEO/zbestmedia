...
const EnvSchema = z.object({
  ...
  LEAD_MAX_EVENT_PAYLOAD_BYTES: z.coerce.number().int().positive().default(16_384),
  LEAD_MAX_CONVERSION_META_BYTES: z.coerce.number().int().positive().default(16_384),
  LEAD_MAX_INTAKE_ATTR_BYTES: z.coerce.number().int().positive().default(16_384),
  LEAD_ROUTE_SLOW_BUDGET_MS: z.coerce.number().int().positive().default(250),
